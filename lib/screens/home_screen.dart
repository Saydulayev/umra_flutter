  ...
  Widget build(BuildContext context) {
    ...
    final LiquidGlassSettings glassSettings = isDark
        ? const LiquidGlassSettings(
            // Более прозрачное «жидкое стекло» (iOS 26): тёмный тинт, но
            // низкая непрозрачность — фон читается сквозь стекло.
            glassColor: Color.fromRGBO(12, 12, 14, 0.38),
        ...
        : const LiquidGlassSettings(
            // Более прозрачное стекло и на светлой теме (0.72 → 0.55). Видимость
            // теперь держит не плотность заливки, а «парящая» тень снизу.
